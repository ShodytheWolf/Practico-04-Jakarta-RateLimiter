...
public class ValidadorDeCredenciales implements IdentityStore {
	...
	private HashMap<String, UsuarioSistema> hashUsuarios = new HashMap<String, UsuarioSistema>();
	
	@PostConstruct
	public void inicializar() {
	
		hashUsuarios.put("usr1", new UsuarioSistema("usr1", "usr1pass", 
				new ArrayList<String>(Arrays.asList("admin")))); //cambio el tipo de usr1 para que pueda ejecutar el endpoint del RateLimiter
